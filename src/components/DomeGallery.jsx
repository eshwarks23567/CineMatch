 ...
 * - Lazy loading: Images load only when near viewport (loading="lazy")
 * - Async decoding: Non-blocking image decode (decoding="async")
 * - Code splitting: Vendor chunks separated (React: 45KB, Motion: 48KB gzipped)
 * - Debounced input: React's batching handles updates efficiently
 * - Total bundle: ~112KB gzipped (main + vendors)
 */
